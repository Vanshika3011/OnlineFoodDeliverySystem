...
public class RestaurantDao {
    public static void registerRestaurant(model.Restaurant rest, int generatedId) throws DAOLayerException {
        try {
    ...
    public static void viewAllRestaurants() throws DAOLayerException {
        try {
